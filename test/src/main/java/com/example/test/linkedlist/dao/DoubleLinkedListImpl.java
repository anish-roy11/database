...
import com.example.test.linkedlist.dao.DoubleLinkedListNode;
import com.example.test.linkedlist.dao.DoubleLinkedList;
...
public class DoubleLinkedListImpl {
    ...
    public DoubleLinkedList createDoubleLinkedList()
    {
        ...
        DoubleLinkedListNode _1 = new DoubleLinkedListNode(1);
        DoubleLinkedListNode _2 = new DoubleLinkedListNode(2);
        DoubleLinkedListNode _3 = new DoubleLinkedListNode(3);
        DoubleLinkedListNode _4 = new DoubleLinkedListNode(4);
        DoubleLinkedListNode _5 = new DoubleLinkedListNode(5);



        DoubleLinkedList doubleLinkedList = new DoubleLinkedList();
        doubleLinkedList.head = _1;
